...
REPO="https://raw.githubusercontent.com/NiLphreakz/VVV/main/"
...
function pasang_ssl() {
    ...
    curl https://raw.githubusercontent.com/NiLphreakz/VVV/main/acme.sh -o /root/.acme.sh/acme.sh
...
function install_xray(){
    ...
    xraycore_link="https://github.com/NiLphreakz/Xcore-custompath/releases/download/v1.0.0/xray.linux.64bit"
...
function download_config(){
    ...
    # > Add menu, thanks to NiLphreakz <3
