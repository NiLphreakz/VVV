...
### INSTALL SCRIPT
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/NiLphreakz/VVV/main/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
